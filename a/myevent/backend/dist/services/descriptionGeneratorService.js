...
exports.descriptionGeneratorService = void 0;
...
class DescriptionGeneratorService {
    ...
    getPromptForAction(title, currentDescription, action) {
...
Event Title: "${title}"`;
    ...
    async generateDescription(request) {
        ...
        const { system, user } = this.getPromptForAction(request.title, request.currentDescription, request.action);
        try {
            ...
            throw new Error('Failed to generate description. Please try again or write manually.');
        }
    }
}
exports.descriptionGeneratorService = new DescriptionGeneratorService();
//# sourceMappingURL=descriptionGeneratorService.js.map