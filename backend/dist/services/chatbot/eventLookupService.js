...
exports.eventLookupService = exports.EventLookupService = void 0;
...
class EventLookupService {
     ...
     */
    async getEventResponse(message) {
        try {
    ...
    async getEventByName(eventName) {
        try {
            ...
            const formattedDate = (0, dateFormatter_1.formatDate)(event.date);
    ...
    async getEventsByCategory(category) {
        try {
            ...
            for (const event of events) {
                const formattedDate = (0, dateFormatter_1.formatDate)(event.date);
                const regCount = await Registration_1.Registration.countDocuments({
                    eventId: String(event._id),
                    status: 'registered'
                });
     ...
     * Find events by date
     */
    async getEventsByDate(dateType) {
        try {
            const now = new Date();
            let startDate;
            let endDate;
...
exports.EventLookupService = EventLookupService;
// Export singleton instance
exports.eventLookupService = new EventLookupService();
//# sourceMappingURL=eventLookupService.js.map